    ...
    >
      ...
      <div className="bg-[var(--card-bg)] border border-[var(--border)] rounded text-sm min-h-[60vh] max-h-[80vh] overflow-y-scroll">
        ...
        {appointments.map((item, index) => (
          <div
            key={index}
            className="flex flex-wrap justify-between max-sm:gap-5 max-sm:text-base sm:grid sm:grid-cols-[0.5fr_2fr_1fr_1fr_3fr_1fr_1fr] gap-1 items-center text-[var(--foreground)] py-3 px-6 border-b border-[var(--border)] hover:bg-[var(--muted-bg)]"
          >
