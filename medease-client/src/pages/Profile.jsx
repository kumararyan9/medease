        ...
        <div className="max-w-lg flex flex-col gap-2 text-sm">
          ...
          <div>
            ...
            <div className="grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-neutral-700">
              ...
              <p className="text-[var(--primary)]">{userData.email}</p>
              ...
              {isEdit ? (
                ...
                <p className="text-[var(--primary)]">{userData.phone}</p>
              )}
          ...
          <div className="mt-10">
            {isEdit ? (
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className="border border-[var(--primary)] px-8 py-2 rounded-full hover:bg-[var(--primary)] hover:text-white transition-all cursor-pointer"
