    ...
    <div>
      ...
      <div className="my-10 flex flex-col md:flex-row gap-10 justify-center mb-28 text-sm">
        ...
        <div className="flex flex-col justify-center gap-6 items-start">
          ...
          <p className="text-gray-500">Connaught Place, New Delhi<br />India — 110001</p>
          <p className="text-gray-500">Tel: +91 98765 43210<br />Email: support@medease.in</p>
          <p className="font-semibold text-lg text-gray-600 uppercase">Careers at MedEase</p>
